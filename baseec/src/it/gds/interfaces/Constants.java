...
public interface Constants {
	...
	public static final String HQL_CARTDETT = "FROM Carrellodett WHERE codice_prodotto = :codice_gds AND id_carrello = :id_carrello";
	public static final String HQL_CARTDETT2 = "FROM Carrellodett WHERE codice_prodotto = :codice_prodotto AND descrizione like :descrizione AND id_carrello = :id_carrello";
