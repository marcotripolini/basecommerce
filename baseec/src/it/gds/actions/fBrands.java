...
public class fBrands extends ActionSupport {
...
//			Connection conn = ((SessionImpl)HibernateUtil.getSessionFactory().openSession()).connection();
			...
			ResultSet rs = null;
			try {
				String sql = "SELECT DISTINCT marchio, id FROM marchi_categorie WHERE categoria_gds = '" + getAisle() + "' ORDER BY marchio LIMIT 0, 11";
