...
public class Config {
	...
	public static String getNOMEONLINE() {
		ReadProperty r = ReadProperty.getInstance();
		String result = "";
		if (Config.isDebug() == true) {
			result = r.getProperty("debug_nome_online");
		} else if (Config.isDebug() == false) {
			result = r.getProperty("release_nome_online");
		}
		return result;
	}
	...
	public static String getCategorieShop() {
		ReadProperty r = ReadProperty.getInstance();
		String result = "";
		if (Config.isDebug() == true) {
			result = r.getProperty("debug_categorie_shop");
		} else if (Config.isDebug() == false) {
			result = r.getProperty("release_categorie_shop");
		}
		return result;
	}
