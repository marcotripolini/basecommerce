					...
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<p>
							<span style="font-size: 15pt;"">
								Le nostre carni provengono solo da animali allevati in Italia, con tracciabilit&agrave; trasparente e documentata, a garanzia di un prodotto sicuro, genuino e garantito.<br>
								I nostri <b>hamburger</b> sono preparati ogni giorno dai nostri chef, che selezionano i tagli migliori e li preparano esclusivamente per la giornata.<br>
								<br><br>
								Per darti ogni giorno il massimo della <b>qualit&agrave;</b>, del <b>gusto</b> e della <b>sicurezza</b>.
							</span>
...
<!-- 			</> -->
			...
			<br>
			<hr>
			<canvas id="the-canvas-0" style="width:100% !important">
...
<script>
	...
	loadingTask.promise.then(function(pdf) {
	  ...
	  pdf.getPage(pageNumber).then(function(page) {
	    ...
	    var canvas = document.getElementById('the-canvas-0');
...
<%
	if (request.getParameter("src") != null) {
		if (request.getParameter("src").contains("f")) {
			...
			String message = "contatto fb menu hamburger www.gdsbistrot.it/vg/ ";
			message += "ricevuto il "
