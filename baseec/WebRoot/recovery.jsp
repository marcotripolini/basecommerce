...
<div class="container-fluid bg0" id="login-box">
	<div class="row">
		...
		<div class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 col-xs-6 col-xs-offset-3">
			<form method="post" action="dorecovery.jsp" autocomplete="off">
				<div class="form-group">
					<label class="label-custom">Codice tessera</label>
					<input type="text" name="card" class="form-control form-control-custom bor8" autocomplete="off">
				</div>
				<div class="form-group">
					<label class="label-custom">Email</label>
					<input type="text" name="email" class="form-control form-control-custom bor8" autocomplete="off">
				</div>
				<br>
				<div class="form-group">
					<button type="submit" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Ripristina</button>
				</div>
			</form>
